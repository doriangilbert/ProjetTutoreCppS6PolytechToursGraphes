...
***** CLISTE<MTYPE> avec uiLISTaille à 0 et le pointeur pLISListe aussi  *****
...
***** Sortie :                                                            *****
***** Entraine : Le contructeur a initialisé un objet                     *****
***** CLISTE<MTYPE> qui est une recopie de la liste passé en paramètre OU *****
...
***** Nécessite :                                                                           *****
***** Sortie : type générique MTYPE, correspondant à l'element de la position de la liste   *****
***** Entraine : LISLireElement()=pLISListe[uiPosition] OU                                  *****
***** EXCEPTION DepassementDeTaille: Essaye d'acceder à un element hors de la liste         *****
************************************************************************************************/
...
***** Nécessite :                                                                           *****
***** Sortie :																				*****
***** Entraine : Reallouer la nouvelle liste avec une taille plus grande de 1 et rajouter   *****
***** l'element à la fin de la liste														*****
************************************************************************************************/
...
*************************************************************************************************
***** Entrée :uiPosition, entier non signé correspond à la position de l'element à modifier *****
***** MTYPEParam, type générique, correspondant à l'element qui va remplacer l'autre        *****
***** Nécessite :                                                                           *****
***** Sortie :																				*****
***** Entraine : pLISListe[uiPosition]=MTYPE OU											    *****
***** EXCEPTION DepassementDeTaille: Ne peut pas modifier un element hors de la liste		*****
************************************************************************************************/
...
**************************************************************************************************
***** Entrée :uiPosition, entier non signé correspond à la position de l'element à supprimer *****
***** Nécessite :                                                                            *****
***** Sortie :																				 *****
***** Entraine : La nouvelle liste avec tous les elements de la liste avant uiPosition non   *****
***** modifié et autres avec un decalage de 1 OU                                             *****
...
/*************************************************************************************************
***** LISAFFICHER : Permet d'afficher la liste                                        ************
**************************************************************************************************
***** Entrée :																			     *****
***** Nécessite :                                                                            *****
***** Sortie :																				 *****
***** Entraine : Affiche dans la console la liste                                            *****
